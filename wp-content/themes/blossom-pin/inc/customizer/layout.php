    ...
    $wp_customize->add_control(
		new Blossom_Pin_Radio_Image_Control(
			...
			array(
				...
				'description' => __( 'This is the general sidebar layout for pages. You can override the sidebar layout for individual page in repective page.', 'blossom-pin' ),
				'choices'	  => array(
    ...
    $wp_customize->add_control(
		new Blossom_Pin_Radio_Image_Control(
			...
			array(
				...
				'description' => __( 'This is the general sidebar layout for posts. You can override the sidebar layout for individual post in repective post.', 'blossom-pin' ),
				'choices'	  => array(
                    'centered'      => get_template_directory_uri() . '/images/1cc.jpg',
					'left-sidebar'  => get_template_directory_uri() . '/images/2cl.jpg',
                    'right-sidebar' => get_template_directory_uri() . '/images/2cr.jpg',

...
function blossom_pin_banner(){
    ...
    $banner_subtitle   = get_theme_mod( 'banner_subtitle', __( 'Discover how people in the community looks create pins to get their attention?', 'blossom-pin' ) );
    ...
    if( !is_404() ){ ?>
        <?php if( is_single() ) { ?>
            <header class="post-entry-header">
                <?php if( !$ed_cat_single) blossom_pin_category(); ?>
        ...
        elseif( is_archive() || is_search() ) { ?>
            ...
            echo '<header class="single-page-header"><h1 class="single-page-title">';
            single_post_title();
            echo '</h1></header>';
        } 
        /**
    ...
    ?>
        <div class="meta-info">
            <div class="entry-meta">               
                <?php 
                if( ! $ed_post_author) blossom_pin_posted_by();
                if( is_single() ){
                    if( ! $ed_post_date ) blossom_pin_posted_on();
                } 
...
function blossom_pin_author(){ 
    ...
    if( ( is_single() && ! $ed_author && $author_title ) || is_author() ){ ?>
    ...
    <div class="footer-b">
		<div class="container">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/downloads/blossom-pin-free-wordpress-theme' ) .'" rel="author" target="_blank">'. esc_html__( 'Blossom Pin', 'blossom-pin' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'blossom-pin' ) ;
